...
import { ALTERASTATUSINFANTIL_V1, BASE_URL } from "../../../functions/urlbase";

const LinhasDaTabelaCobranca = (props) => {
  ...
  async function alteraStatusCobranca() {
    ...
    try {
      ...
      const result = await fetch(BASE_URL + ALTERASTATUSINFANTIL_V1, {
        method: "PATCH",
        headers: {
...
export default LinhasDaTabelaCobranca;
