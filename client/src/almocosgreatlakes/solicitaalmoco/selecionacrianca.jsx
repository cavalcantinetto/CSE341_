...
export default function DadosDaCrianca(props) {
                ...
                //passa os dados do estudante para a pagina principal com base no id que é o índex do array.
                  onChange={(e) => {
                    if(e.target[e.target.selectedIndex].id<0) {
                      ...
                      props.handleClick(data[e.target[e.target.selectedIndex].id]);
                    }
              ...
              //passa os dados do estudante para a pagina principal com base no id que é o índex do array.
                onChange={(e) => {
                  if(e.target[e.target.selectedIndex].id<0) {
                    ...
                    props.handleClick(cookies.userData.userKids[e.target[e.target.selectedIndex].id]);
                  }
                }}
